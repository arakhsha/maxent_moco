...
# def get_lr(current_iter, start_lr, total_iter, delay):
#     if current_iter <= delay:
#         return start_lr
#     # return start_lr * (total_iter-current_iter) / (total_iter-delay)
#     return start_lr * 1 / (current_iter - delay)